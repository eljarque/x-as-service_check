...
**Contraste con el consumidor:** las preguntas B1/D1/E2 pueden responderse también desde la perspectiva de **uno o varios equipos consumidores**; cada equipo responde por separado y la app resalta la divergencia proveedor vs cada equipo. Los archivos del esquema antiguo (un solo consumidor) se migran automáticamente al importarlos.
